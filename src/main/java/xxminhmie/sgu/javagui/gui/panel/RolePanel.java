...
//
//		String[] infoName = { "ID: ", "Name: ", "Description: "};
...
//			y += 30;
//			this.infoPanel.add(this.tfList[i]);
//		}
...
//					selectedRow.setDescription((String) table.getModel().getValueAt(rowIndex, 2));
//
//				}
//				/** DISPLAY TO TEXT FIELD **/
//				tfList[0].setText(selectedRow.getId().toString());
//				tfList[1].setText(selectedRow.getName());
//				tfList[2].setText(selectedRow.getDescription());
//				
...
//		 */
//		this.tfList[4].addKeyListener(new KeyAdapter() {
//			@Override
//			public void keyPressed(KeyEvent e) {
//				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
