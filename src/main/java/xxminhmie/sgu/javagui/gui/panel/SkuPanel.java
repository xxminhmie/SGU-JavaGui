...
//dung o method add sku vi suy nghi import price co nen null hay khong
//con ham delete nua
public class SkuPanel extends JPanel {
	...
	SkuModel selectedRow = new SkuModel();// Customer is being selected from Table
	...
	public SkuPanel(SkuService service) {
